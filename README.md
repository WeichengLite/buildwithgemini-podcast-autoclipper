...
> **An AI-powered podcast post-production web studio that transforms raw audio into publishable packages—show notes, timestamps, guest profiles, AI cover art, Omni video trailers, and RSS distribution feeds.**
...
6. **Grounding Knowledge Retrieval (RAG)**:
...
│   ├── static/
│   │   └── index.html         # Web Studio Dashboard with Episode Manager & 6 Live Panels
│   └── requirements.txt
├── scripts/
